...
public class PlayerStats {
    ...
    public int writeFile(ArrayList<String> data, String name) throws IOException {
        ...
        else if(data.get(0).equals("SUMMARY") && data.get(1).equals("2022"))
        {
            mod_three = true;
        }
    ...
    public String dataChoice(FileReader data, String name, int career_season) throws IOException {
        ...
        {
            System.out.println("" + name + " did not play this season. Switching to career statistics...");
        ...
        return "" + name + "'s " + season_career + " " + data_category + " total is " + data_number + ".";
    }
